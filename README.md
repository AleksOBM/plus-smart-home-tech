...
- Основной функционал
  - Регистрация подключаемых сенсоров и устройств
  - Получение сигналов от сенсоров, подключенных к сети
  - Выполнение заранее запрограммированного действия в ответ на сигнал от сенсора
  - Пользователь может программировать действия простыми командами
- Телеметрия
  - Сбор статистики срабатывания устройств
  - Хранение снимков состояния по каждому хабу(комнате)
- Коммерция
  - Магазин устройств
